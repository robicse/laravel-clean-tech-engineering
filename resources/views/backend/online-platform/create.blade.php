...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class=""></i> Add Online Platform</h1>
            </div>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('online_platform.index') }}" class="btn btn-sm btn-primary col-sm" type="button">All Online Platform</a>
                </li>
            </ul>
        </div>
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Add Online Platform</h3>
                <div class="tile-body tile-footer">
                    ...
                    @endif
                    <form method="post" action="{{ route('online_platform.store') }}">
                        @csrf
