        ...
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('postingForm.index') }}" class="btn btn-sm btn-primary col-sm" type="button">All Posting </a>
                </li>
            </ul>
        </div>
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body tile-footer">
                    ...
                    @endif
                    <form method="post" action="{{ route('postingForm.store') }}">
                        @csrf
                            ...
                            <tr>
                                <th>
                                    <div class="col-md-12 form-group row">
                                        ...
                                        <div class="col-md-2">
                                            <label class="control-label ">Voucher No <small class="requiredCustom">*</small></label>
        ...
        $(function () {
            ...
            $('.add').click(function () {
                ...
                var tr = '<tr><td class="no">' + n + '</td>' +
                    '<td width="30%"><select class="form-control account_id select2" name="account_id[]" id="account_id_'+n+'" onchange="getval('+n+',this);" required>' + service + '</select></td>' +
                    '<td  width="25%"><select class="form-control ledger_id select2" name="ledger_id[]" id="ledger_id_'+n+'" required>' + ledger + '</select></td>' +
