...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class=""></i> Edit Product Capacity</h1>
            </div>
        ...
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Edit Product Capacity</h3>
                <div class="tile-body tile-footer">
                    ...
                    @endif
                    <form method="post" action="{{ route('productCapacity.update',$productBrand->id) }}">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update Product Capacity</button>
                            </div>
                        </div>
                    </form>
                </div>
