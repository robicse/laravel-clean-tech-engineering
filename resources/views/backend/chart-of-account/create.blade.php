...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class=""></i> Add COA</h1>
            </div>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('ChartOfAccount.index') }}" class="btn btn-sm btn-primary col-sm" type="button">All COA</a>
                </li>
            </ul>
        </div>
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Add COA</h3>
                <div class="tile-body tile-footer">
                    ...
                    <form method="post" action="{{ route('ChartOfAccount.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="group_1" name="group_1" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-md-3 text-right">Group 2 </label>
                            <div class="col-md-8">
                                <input type="text" id="group_2" name="group_2" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-md-3 text-right">Group 3</label>
                            <div class="col-md-8">
                                <input type="text" id="group_3" name="group_3" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-md-3 text-right">Group 4</label>
                            <div class="col-md-8">
                                <input type="text" id="group_4" name="group_4" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-md-3 text-right">Head Type</label>
                            <div class="col-md-8">
                                <input type="text" id="head_type" name="head_type" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
