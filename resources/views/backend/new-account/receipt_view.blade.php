        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="col-sm-4" style="width: 33.33333333%;height:180px; float: left;">
                    ...
                    <p style="margin: 0px">Corporate Office :Corporate Office :Corporate Office : House-1, Road-16,
                        Section-10, Block-C, Mirpur, Dhaka-1216</p>
                        ...
                        <tbody>
                            ...
                            @foreach ($general_ledger_infos as $key => $general_ledger_info)
                                ...
                                <tr>
                                    ...
                                    <td>@php
                                        echo \App\VoucherType::where('id', $general_ledger_info->voucher_type_id)
                                            ->pluck('name')
                                            ->first();
            ...
            <div class="text-center">
                <button onclick="window.print()" target="_blank" id="printPageButton"
                    class=" btn btn-sm btn-primary float-left">Print</button>
            </div>
        </div>
    </main>
